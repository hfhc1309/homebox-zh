...
<template>
  <BaseContainer class="mb-16">
        ...
        <div class="dropdown">
          ...
          >
            <label class="label cursor-pointer mr-auto">
              ...
              <span class="label-text ml-4"> 包括已归档资产 </span>
            </label>
            <label class="label cursor-pointer mr-auto">
            ...
            <hr class="my-2" />
            <BaseButton class="btn-block btn-sm" @click="reset"> 重新搜索 </BaseButton>
          </div>
        </div>
        <div class="dropdown ml-auto dropdown-end">
          ...
          >
            ...
            <ul class="mt-1 list-disc pl-6">
              <li>
                位置和标签过滤器使用“或”操作。如果选择了多个，则只需一个即可匹配。
              </li>
              <li>以“#”为前缀的搜索将查询资产 ID（例如“#000-001”）</li>
              <li>
                字段过滤器使用“或”操作。如果选择了多个，则只需一个即可匹配。
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="mt-10">
      <BaseSectionHeader ref="itemsTitle"> 资产 </BaseSectionHeader>
      ...
      <div ref="cardgrid" class="grid mt-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div class="hidden first:inline text-xl">未找到任何资产</div>
      </div>
