    ...
    <div>
      <header class="p-4 sm:px-6 lg:p-14 sm:py-6 sm:flex sm:items-end mx-auto">
        <div>
          ...
          <p class="ml-1 text-lg text-base-content/50">追踪、组织和管理您的物品。</p>
        </div>
            ...
            <form v-if="registerForm" @submit.prevent="registerUser">
              <div class="card w-max-[500px] md:w-[500px] bg-base-100 shadow-xl">
                <div class="card-body">
                  ...
                  <FormTextField v-model="email" label="设置你的邮箱" />
                  <FormTextField v-model="username" label="设置你的名字" />
                  ...
                  <FormPassword v-model="password" label="设置你的密码" />
