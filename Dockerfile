...
#RUN npm install workbox-window --save --registry=https://registry.npmmirror.com/
RUN pnpm install --registry=https://registry.npmmirror.com --frozen-lockfile --shamefully-hoist
COPY frontend .
RUN pnpm build
